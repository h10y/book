...
- `faithful`: a "Hello Shiny!" app displaying the Old Faithful geyser
  ...
  very basics of of reactivity, and it is very short.
...
### The Bananas Data Set {#part1-example-bananas-data}
...
### Model Training {#part1-example-bananas-model}
...
### The Shiny App {#part1-example-bananas-app}
...
multiple replicas. For such deployments, session affinity (or sticky sessions)\index{Sticky session} needs to 
