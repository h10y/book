...
% Info Box for Cloud Providers
\usepackage{tcolorbox}
\usepackage{enumitem}
\newcommand{\cloudservice}[5]{
    \begin{tcolorbox}[colback=blue!5!white, colframe=blue!80!black, title={\textbf{#1} \textbf{Key Considerations}}, sharp corners=southwest, boxrule=0.5mm]
        \textbf{Costs:} 
        \begin{itemize}
            #2
        \end{itemize}
