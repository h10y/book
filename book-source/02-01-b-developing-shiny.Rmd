...
So we create a file called `index.Rmd`. Look for the file inside the `rmd-shiny`
...
#### Quarto with R {#part2-quarto-with-r}
...
#### Shinylive in Quarto {#part2-shinylive-quarto}
...
The Quarto Shinylive examples can be found inside the `quarto-r-shinylive` and
`quarto-py-shinylive` folders of the Faithful repository.
