...
Shiny is a reactive web application framework used by **R** and 
**Python** users to communicate their data analysis results to others. Whether 
...
20 hosting options for Shiny. 
Navigating these options and finding advice on choosing the best one and 
...
usually narrowly focused and never really ask important questions such as: 
Why do you want this app to be deployed? Who is this app for? What is your budget? 
The goal of the book is to help you learn about the hosting options and what 
it takes to host your apps securely.

Current available books focus on the R aspect of Shiny,
...
we cover both in the same book. We think this is important, because with the 
increasing popularity of Shiny available for R and Python, learning more about 
the hosting side of the application lifecycle will be a critical need for 
...
- How do I decide which of these options suits my needs, my budget, and my skill 
  level the best? 
- How can I get started, and where can I get help if I get stuck? 

If you are not (yet) asking these questions, but want to learn about servers, 
cloud instances, and containers from the perspective of Shiny apps, this book is 
still for you.

You might be a researcher in academia, government, or at a nonprofit 
...
You might work at a small agency or a startup and want to securely host 
apps for your clients and users. Or you might be a data scientist who wants 
to effectively collaborate with people in the IT and engineering department
on Shiny app deployment and hosting. This book is an invaluable resource
to learn about all aspects of hosting Shiny applications.
...
- Part III. Hosting Shiny Apps -- This part describes all the ways of how Shiny
...
- Part IV. What is Next? -- You will find an overview of more advanced options 
  for your Shiny app. This includes topics like hosting your own deployment platform 
  and managing infrastructure as code—concepts that are more challenging to cover fully 
  in a physical book format.

The book does not end on the last page. You can find up-to-date supplementary online material,
including the HTML version of the book and all the code that we present
in the book and more on the book's website at <https://hostingshiny.com>.
...
interfaces with Shiny. You can find all about those topics in these excellent books:
...
Kalvin Eng is a PhD candidate in Computing Science at the University of Alberta 
with over 15 years of software development experience. His research involves 
understanding and improving the processes of software engineering. He is 
passionate about helping organizations develop efficient processes to build 
...
We also want to give a shout out to the _Felice Cafe_ in Edmonton where
we spent many hours working on the book.
...
- Alex Ellis
- Mention the HDA blog and community support through feedback and encouragement
- Michael Thomas, Eric Nantz.
- Dean Attali
-->
...
<!--
REVIEW:
- "The documentation and books about the Shiny ecosystem are phenomenal resources" - this sentence seems out of 
   place, does not flow with the paragraph.
- Second paragraph mentions that "finding up-to-date advice" is hard, implying that this book will 
  provide that. Since this book will be a print format, it will certainly not be "up-to-date" for 
  a very long time. If this was an online book, you could argue that the author would continuously 
  update the book to keep it updated. But if this is planned to be printed, I would not mention 
  the "up-to-date" issue because this book is not going to fix that.
- The "Who Is This Book For?" section ends awkwardly. It needs a good strong sentence or short paragraph to end with
- One of the most important definitions is missing. What is "hosting", what exactly is meant by "hosting a Shiny app"?
- I'm noticing many awkward sentence structures and choices of words, this book should go through a proper copy editor
- Part IV is called "What is next", it should be changed to "What's next" which is a much more natural phrase
- Conventions: Ironically, this paragraph needs to follow conventions more strictly. Sometimes examples 
  are in parentheses and sometimes not, sometimes examples include the word "e.g." and sometimes not, sometimes 
  URLs have a trailing slash and sometimes not. The inconsistency is distracting.
- Conventions: it's strange to read this as a paragraph. It might be easier to read as bullet points.
- In general, the written tone is EXTREMELY casual. Perhaps this is on purpose and is fine. I just want to point it out, because to me it makes the book be perceived as a little less legitimate/professional. But this is a design decision, perhaps it's a conscious decision.
-->